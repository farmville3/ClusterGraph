...
========================================================================================================================
   ...
   ***Numpy est une librairie nécessaire au fonctionnement de la méthode stats pour les graphs***

   --> https://www.scipy.org/install.html
   --> http://askubuntu.com/questions/509623/installation-procedure-for-numpy-and-other-python-3-4-packages-on-ubuntu-14-04

   Pour ceux sur windows, vous pouvez intaller Anaconda qui installe automatiquement la librairie Numpy.
